...
* cPanel and phpMyAdmin to support the database that stores players stories and information
* GitHub allowing for version control and collaboration
* PhpStorm by Jetbrains as our coding environment
